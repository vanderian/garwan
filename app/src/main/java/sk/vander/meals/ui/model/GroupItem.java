package sk.vander.meals.ui.model;

import java.util.List;

import auto.parcelgson.AutoParcelGson;
import rx.Observable;
import sk.vander.meals.data.database.model.AddOnDao;
import sk.vander.meals.data.database.model.AddOnCategoryDao;
import sk.vander.meals.data.database.model.MealDao;
import sk.vander.meals.data.database.model.MealCategoryDao;
import sk.vander.meals.ui.adapter.ExpandGroupItem;
